...
#define TCPOLEN_MP_CAPABLE_DLL_WOCS 22 /* Third packet with data-level length and without checksum. */
#define TCPOLEN_MP_CAPABLE_DLL 24 /* Third packet with data-level length and checksum. */
//MP_JOIN
